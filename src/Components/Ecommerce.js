        ...
        <div className="projectpopup">
            ...
            <div className="explanation">
                ...
                <div className="explanationright">
                    ...
                    <br></br>
                    <br></br>
                    View this project on GitHub: <a className="links" href="https://github.com/ShaneYokota72/Ecommerce-Service" target="_blank" rel="noreferrer">E-Commerce Terminal Service</a>
                    </p>
