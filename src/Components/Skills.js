    ...
    return(
        <div className="skillparent" id="skills">
            ...
            <div className="codinglanguageicons"> 
                ...
                <img className="clangicons" alt="codinglanguageicons" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original-wordmark.svg" style={{filter: "invert(1)"}}/>
                <img className="clangicons" alt="codinglanguageicons" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/materialui/materialui-plain.svg" />
                ...
                <img className="clangicons" alt="codinglanguageicons" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-plain-wordmark.svg" />   
